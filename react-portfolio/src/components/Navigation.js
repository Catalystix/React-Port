  ...
  return (
    <nav class="bg-none opacity-1 border-gray-200 grid place-content-center dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap grid place-content-center  justify-between mx-auto p-4">
        ...
        <div  >
          <ul class="font-medium  flex flex-col p-4 md:p-0 mt-4 border border-800 rounded-lg bg-gray-900 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#home"  onClick={() => setCurrentPage('Home')}
          className={currentPage === 'Home'  ? 'nav-link active' : 'nav-link'} class="block py-2 pl-3 pr-4 text-gray-900 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500 active:text-blue-500" aria-current="page">Home</a>
            </li>
            <li>
